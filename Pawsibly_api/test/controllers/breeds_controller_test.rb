...
class BreedsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create breed" do
    assert_difference('Breed.count') do
      post breeds_url, params: { breed: { name: @breed.name, user_id: @breed.user_id } }, as: :json
    end
  ...
  test "should update breed" do
    patch breed_url(@breed), params: { breed: { name: @breed.name, user_id: @breed.user_id } }, as: :json
    assert_response 200
  end
